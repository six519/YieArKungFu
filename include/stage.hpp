...
#define VILLAIN_FB_SPEED_RUN 16
#define VILLAIN_RUN_BOUNDARY 10
#define SPINNING_CHAIN_SPEED 6
#define VILLAIN_BACK_DISTANCE 3
...
#define END_STATE_VILLAIN_LIE_DOWN 1
#define END_STATE_VILLAIN_MOVE_FEET 2
#define END_STATE_VILLAIN_END 3
#define END_STATE_VILLAIN_GAME_OVER 4
